...
output_path = "/dbfs/tmp/streaming_transactions/transactions.json"  # Appending to a single file
os.makedirs("/dbfs/tmp/streaming_transactions", exist_ok=True)
...
while True:
    ...
    print(f"Appended {rows_per_batch} rows.")
